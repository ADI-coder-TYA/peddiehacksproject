...
class _StudentMainScreenState extends State<StudentMainScreen> {
          ...
          return Scaffold(
            body: BoutiqueBackground(
              child: SafeArea(
                child: Column(
                  children: [
                    _buildStudentHeader(isMobile, isConnected, user),
                    Expanded(
                      child: isMobile
  ...
  Widget _buildMobileNavBar() {
    return Container(
      decoration: const BoxDecoration(
        border: Border(top: BorderSide(color: Color(0x1A0D9488), width: 1)),
      ),
      child: NavigationBar(
        selectedIndex: _selectedIndex,
        onDestinationSelected: (int index) {
  ...
  Widget _buildStudentHeader(bool isMobile, bool isConnected, dynamic user) {
    return Container(
